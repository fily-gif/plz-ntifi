...
def main(server):
	with connect(server) as ws:
		...
		# subscribing to SessionsStart with initialdelay 0, interval 1500
		# ...this means that it sends as soon as possible (0), and then "polls" every 1500ms (god i hate jellyfin api)
		while True:
